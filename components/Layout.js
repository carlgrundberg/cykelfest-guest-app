  ...
  return (
    <IntlProvider locale="sv-SE">
      <Head>
        ...
        <script src="https://polyfill.io/v3/polyfill.min.js?features=Intl,Intl.RelativeTimeFormat,Intl.PluralRules.~locale.sv,Intl.RelativeTimeFormat.~locale.sv"></script>
      </Head>
